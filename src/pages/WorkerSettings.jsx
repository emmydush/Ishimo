      ...
      <div className="main-content">
        <header style={{ marginBottom: '40px' }}>
          <h1 style={{ fontSize: '2.5rem', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Settings size={36} color="var(--accent-emerald)" /> Account Settings
          </h1>
          <p style={{ color: 'var(--text-muted)' }}>Manage your security and preferences.</p>
        </header>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="glass-panel" style={{ padding: '32px', height: 'fit-content' }}>
            <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px' }}>
              <Bell size={20} color="var(--accent-emerald)" /> Notifications
            </h3>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 0', borderBottom: '1px solid var(--border-color)' }}>
              <div>
                ...
                <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>Receive emails for new job requests</div>
              </div>
              <input type="checkbox" defaultChecked style={{ width: '20px', height: '20px', accentColor: 'var(--accent-emerald)' }} />
            </div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 0' }}>
              <div>
                <div style={{ fontWeight: 500 }}>SMS Alerts</div>
                <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>Get text messages for urgent requests</div>
              </div>
              <input type="checkbox" style={{ width: '20px', height: '20px', accentColor: 'var(--accent-emerald)' }} />
            </div>
          </motion.div>
        </div>
      </div>
